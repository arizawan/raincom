...
@section('bodycontent')
	<!-- Content wrapper -->
		    <div class="wrapper">
               ...
               <form class="form-horizontal validate" action="/admin/category/new" method="post" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="widget row-fluid">
						    ...
						    <div class="well">
						        ...
						        <div class="control-group">
						            ...
						            <div class="controls"><input type="text" name="title" class="input-xxlarge catnamelimit100 validate[required,custom[onlyLetterNumberSp]]" id="cattitle" />
									<span class="help-block" id="catname100lim">Field limited to 100 characters.</span>
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Link Slug :</label>
						            <div class="controls"><input type="text" name="link" class="input-xxlarge catlinklimit100 validate[required,custom[onlyUrlSlug]]" id="cattitleslug"/>
