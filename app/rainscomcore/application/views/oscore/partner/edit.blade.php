		    ...
		    <div class="wrapper">
			    ...
			    <div class="crumbs">
		            <ul id="breadcrumbs" class="breadcrumb"> 
		                ...
		                <li class="active"><a href="/oscore/controlboard" title="">Edit Partner</a></li>
		            </ul>
			    </div>
			    <!-- /breadcrumbs line -->
			    ...
			    <div class="page-header">
			    	<div class="page-title">
				    	<h5>Edit Partner</h5>
				    	<span>Modify Partner Details</span>
			    	</div>
					<ul class="page-stats">
			    		<li>
			    			<div class="showcase">
				...
				<form class="form-horizontal validate" action="/admin/partner/edit/{{$partnertoedit->id}}" method="post" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="widget row-fluid">
						    ...
						    <div class="well">
						        <div class="control-group">
						            ...
						            <div class="controls"><input type="text" name="name" class="input-xxlarge catnamelimit100 validate[required,custom[onlyLetterNumberSp]]" value="{{$partnertoedit->name}}"/>
									<span class="help-block" id="catname100lim">Field limited to 100 characters.</span>
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Address :</label>
						            <div class="controls"><input type="text" name="address" class="input-xxlarge validate[required]" value="{{$partnertoedit->address}}" />
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Email :</label>
						            <div class="controls"><input type="text" name="email" class="input-xlarge validate[required,custom[email]]" value="{{$partnertoedit->email}}" />
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Phone :</label>
						            <div class="controls"><input type="text" name="phone" class="input-xlarge validate[required]" value="{{$partnertoedit->phone}}" />
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Latitute :</label>
						            <div class="controls"><input type="text" name="lalitute" class="input-xlarge" value="{{$partnertoedit->latitude}}" />
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Longtitude :</label>
						            <div class="controls"><input type="text" name="longtituted" class="input-xlarge" value="{{$partnertoedit->longitude}}" />
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Pin Code :</label>
						            <div class="controls"><input type="text" name="pincode" class="input-xlarge validate[required,custom[onlyLetterNumberSp]]" value="{{$partnertoedit->pincode}}" />
									</div>
						        </div>
								<div class="control-group">
						            <label class="control-label">Password :</label>
						            <div class="controls"><input type="text" name="password" class="input-xlarge validate[required]" value="{{$partnertoedit->password}}" />
									</div>
						        </div>
								<div class="control-group">
								...
								<div class="control-group">
						            ...
						            <div class="controls">
						            	@if ( $partnertoedit->isvisible == 'yes' )
										    <label class="radio inline">
												<input type="radio" id="d" name="isvisibe" class="styled" value="yes" checked>
												Yes
											</label>
											<label class="radio inline">
												<input type="radio" id="f" name="isvisibe" class="styled" value="no" >
												No
											</label>
										@else
										    <label class="radio inline">
								...
								<div class="control-group">
						            <div class="widget">
										...
										<textarea name="editor" class="ckeditor">{{$partnertoedit->details}}</textarea>
									</div>
						        </div>
